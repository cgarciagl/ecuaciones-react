export function Header() {
  return (
    <header className="flex items-center justify-between gap-4 min-h-[82px] px-5 py-4 border border-line/80 rounded-[18px] bg-[linear-gradient(130deg,rgba(255,255,255,0.86),rgba(247,251,247,0.92))] shadow-[0_16px_40px_rgba(21,35,27,0.1)] backdrop-blur-xl col-span-full">
